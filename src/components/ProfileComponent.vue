  ...
  <div class="profile-container">
    <div class="profile-left desktop-only">
      ...
      <div class="camera-placeholder">
        <img :src="CameraIcon" alt="Camera" @click="uploadPhoto">
      </div>
    </div>
    ...
    <div class="mobile-only mob-bg">
      ...
      <div class="mobile-avatar">
        <img :src="Vector1" alt="Camera" @click="uploadPhoto">
      </div>
    </div>
    ...
    <div class="profile-info">
      ...
      <div class="info-group">
        ...
        <input class="info-value" type="input" v-model="userData.birthday">
      </div>
